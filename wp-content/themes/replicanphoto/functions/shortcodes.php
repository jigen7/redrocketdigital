...
//about link shorcodes
function listpad_shortcode($atts, $content = null) {
extract(shortcode_atts(array("url" => ''), $atts));
    return '<li><a href="' . $url . '">' . do_shortcode($content) . '</a></li>';
}
add_shortcode('listpad', 'listpad_shortcode');

// slider images shortcodes
function sliderimage_shortcode($atts, $content = null) {
    return '<li><img src="'. do_shortcode($content) .'" alt=""></li>';
}
add_shortcode('sliderimage', 'sliderimage_shortcode');
?>
